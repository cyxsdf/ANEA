...
if __name__ == '__main__':
    ...
    def objective(trial):
        ...
        if dataset == 'mosi' or dataset == 'mosei_senti' or dataset == 'iemocap' or \
            ...
            if not hyp_params.use_bert:
                acc = train_urfunny.initiate(hyp_params, train_loader, valid_loader, test_loader)
            else:
